...
class WarehouseControllerTest extends TestCase
{
    ...
    public function test_show(){
        ...
        $this->getJson("api/$this->uri/$warehouse->id")
            ->assertStatus(200)
            ->assertJson(['data'=>[]]);
    }
    ...
    public function test_show_deleted(){
        ...
        $warehouse->delete();
        $this->getJson("api/$this->uri/deleted/$warehouse->name")
            ->assertStatus(200)
            ->assertJson(['data'=>[]]);
    }
...
//        $this->withoutExceptionHandling();
    ...
    public function test_update(){
        ...
        $this->putJson("api/$this->uri/$warehouse->id", $json)
            ->assertStatus(200)
    ...
    public function test_destroy(){
        ...
        $this->deleteJson("api/$this->uri/$warehouse->id")
            ->assertStatus(200)
    ...
    public function test_restore(){
        ...
        $warehouse->delete();
        $this->putJson("api/$this->uri/deleted/$warehouse->name/restore")
            ->assertStatus(200)
