...
//        $this->withExceptionHandling();
    ...
    public function test_show(){
        ...
        $this->getJson("api/$this->uri/$MeasureUnit->id")
            ->assertStatus(200)
            ->assertJson(['data'=>[]]);
    }
    ...
    public function test_show_deleted(){
        ...
        $MeasureUnit->delete();
        $this->getJson("api/$this->uri/deleted/$MeasureUnit->name")
            ->assertStatus(200)
            ->assertJson(['data'=>[]]);
    }
...
//        $this->withoutExceptionHandling();
    ...
    public function test_update(){
        ...
        $this->putJson("api/$this->uri/$MeasureUnit->id", $json)
            ->assertStatus(200)
    ...
    public function test_destroy(){
        ...
        $this->deleteJson("api/$this->uri/$MeasureUnit->id")
            ->assertStatus(200)
    ...
    public function test_restore(){
        ...
        $MeasureUnit->delete();
        $this->putJson("api/$this->uri/deleted/$MeasureUnit->name/restore")
            ->assertStatus(200)
